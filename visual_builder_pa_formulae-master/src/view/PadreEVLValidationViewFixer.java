...
public class PadreEVLValidationViewFixer extends ValidationViewFixer {
	...
	protected PadreEVLValidationView getValidationView() {
		...
		PlatformUI.getWorkbench().getDisplay().syncExec(new Runnable() {
			public void run() {
				try {
					validationViewWrapper.validationView = (PadreEVLValidationView) PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().showView("view.PadreEVLValidationView");
