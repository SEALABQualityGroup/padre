...
public class saveEolListener implements SelectionListener {
	...
	public saveEolListener(Text eolcode, org.eclipse.swt.widgets.List library, String workspace, List<AST> ops,
