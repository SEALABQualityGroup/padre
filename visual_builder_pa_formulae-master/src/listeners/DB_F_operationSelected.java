...
public class DB_F_operationSelected implements SelectionListener {
	...
	public DB_F_operationSelected(List<Integer> ops, org.eclipse.swt.widgets.List visualops, Text area) {
		this.ops = ops;
