...
public class CreateEOLfileListener_Deprecated implements SelectionListener {
	
	private Shell shell;
	private org.eclipse.swt.widgets.List library;
	private String workspace, EOLfileName;
	
	public CreateEOLfileListener_Deprecated(Shell s, org.eclipse.swt.widgets.List library, String workspace) {
