...
public class DialogEOLfileName extends TitleAreaDialog {

	private Text txtFixTitle;
	  

	  private String contextName;
	  private String title="Insert EOL file name",message="Insert the name",lab="Filename";
	  

	  public DialogEOLfileName(Shell parentShell) {
	    super(parentShell);
