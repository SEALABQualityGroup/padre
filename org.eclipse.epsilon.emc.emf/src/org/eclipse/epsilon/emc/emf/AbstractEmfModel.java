...
public abstract class AbstractEmfModel extends CachedModel<EObject> {
	...
	public boolean _store_current_model(String reason) {
		...
		//'session' string will be the name of the directory containing the results of the session
	...
	{
		session = "Refactoring_del_" + timestamp;
	}
