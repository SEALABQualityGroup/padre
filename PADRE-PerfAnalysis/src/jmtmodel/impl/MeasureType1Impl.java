...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Measure Type1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link jmtmodel.impl.MeasureType1Impl#getAlfa <em>Alfa</em>}</li>
 *   <li>{@link jmtmodel.impl.MeasureType1Impl#getAnalyzedSamples <em>Analyzed Samples</em>}</li>
 *   <li>{@link jmtmodel.impl.MeasureType1Impl#getDiscardedSamples <em>Discarded Samples</em>}</li>
 *   <li>{@link jmtmodel.impl.MeasureType1Impl#getLowerLimit <em>Lower Limit</em>}</li>
 *   <li>{@link jmtmodel.impl.MeasureType1Impl#getMaxSamples <em>Max Samples</em>}</li>
 *   <li>{@link jmtmodel.impl.MeasureType1Impl#getMeanValue <em>Mean Value</em>}</li>
 *   <li>{@link jmtmodel.impl.MeasureType1Impl#getMeasureType <em>Measure Type</em>}</li>
 *   <li>{@link jmtmodel.impl.MeasureType1Impl#getNodeType <em>Node Type</em>}</li>
 *   <li>{@link jmtmodel.impl.MeasureType1Impl#getPrecision <em>Precision</em>}</li>
 *   <li>{@link jmtmodel.impl.MeasureType1Impl#isSuccessful <em>Successful</em>}</li>
 *   <li>{@link jmtmodel.impl.MeasureType1Impl#getUpperLimit <em>Upper Limit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeasureType1Impl extends MinimalEObjectImpl.Container implements MeasureType1 {
	/**
	...
	protected EClass eStaticClass() {
		return JmtmodelPackage.Literals.MEASURE_TYPE1;
	}
	...
	public void setAlfa(double newAlfa) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JmtmodelPackage.MEASURE_TYPE1__ALFA, oldAlfa, alfa, !oldAlfaESet));
	}
	...
	public void unsetAlfa() {
		...
		alfaESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JmtmodelPackage.MEASURE_TYPE1__ALFA, oldAlfa, ALFA_EDEFAULT, oldAlfaESet));
	}
	...
	public void setAnalyzedSamples(int newAnalyzedSamples) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JmtmodelPackage.MEASURE_TYPE1__ANALYZED_SAMPLES, oldAnalyzedSamples, analyzedSamples, !oldAnalyzedSamplesESet));
	}
	...
	public void unsetAnalyzedSamples() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JmtmodelPackage.MEASURE_TYPE1__ANALYZED_SAMPLES, oldAnalyzedSamples, ANALYZED_SAMPLES_EDEFAULT, oldAnalyzedSamplesESet));
	}
	...
	public void setDiscardedSamples(int newDiscardedSamples) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JmtmodelPackage.MEASURE_TYPE1__DISCARDED_SAMPLES, oldDiscardedSamples, discardedSamples, !oldDiscardedSamplesESet));
	}
	...
	public void unsetDiscardedSamples() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JmtmodelPackage.MEASURE_TYPE1__DISCARDED_SAMPLES, oldDiscardedSamples, DISCARDED_SAMPLES_EDEFAULT, oldDiscardedSamplesESet));
	}
	...
	public void setLowerLimit(double newLowerLimit) {
		...
		lowerLimitESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JmtmodelPackage.MEASURE_TYPE1__LOWER_LIMIT, oldLowerLimit, lowerLimit, !oldLowerLimitESet));
	}
	...
	public void unsetLowerLimit() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JmtmodelPackage.MEASURE_TYPE1__LOWER_LIMIT, oldLowerLimit, LOWER_LIMIT_EDEFAULT, oldLowerLimitESet));
	}
	...
	public void setMaxSamples(int newMaxSamples) {
		...
		maxSamplesESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JmtmodelPackage.MEASURE_TYPE1__MAX_SAMPLES, oldMaxSamples, maxSamples, !oldMaxSamplesESet));
	}
	...
	public void unsetMaxSamples() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JmtmodelPackage.MEASURE_TYPE1__MAX_SAMPLES, oldMaxSamples, MAX_SAMPLES_EDEFAULT, oldMaxSamplesESet));
	}
	...
	public void setMeanValue(double newMeanValue) {
		...
		meanValueESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JmtmodelPackage.MEASURE_TYPE1__MEAN_VALUE, oldMeanValue, meanValue, !oldMeanValueESet));
	}
	...
	public void unsetMeanValue() {
		...
		meanValueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JmtmodelPackage.MEASURE_TYPE1__MEAN_VALUE, oldMeanValue, MEAN_VALUE_EDEFAULT, oldMeanValueESet));
	}
	...
	public void setMeasureType(String newMeasureType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JmtmodelPackage.MEASURE_TYPE1__MEASURE_TYPE, oldMeasureType, measureType));
	}
	...
	public void setNodeType(String newNodeType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JmtmodelPackage.MEASURE_TYPE1__NODE_TYPE, oldNodeType, nodeType));
	}
	...
	public void setPrecision(double newPrecision) {
		...
		precisionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JmtmodelPackage.MEASURE_TYPE1__PRECISION, oldPrecision, precision, !oldPrecisionESet));
	}
	...
	public void unsetPrecision() {
		...
		precisionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JmtmodelPackage.MEASURE_TYPE1__PRECISION, oldPrecision, PRECISION_EDEFAULT, oldPrecisionESet));
	}
	...
	public void setSuccessful(boolean newSuccessful) {
		...
		successfulESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JmtmodelPackage.MEASURE_TYPE1__SUCCESSFUL, oldSuccessful, successful, !oldSuccessfulESet));
	}
	...
	public void unsetSuccessful() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JmtmodelPackage.MEASURE_TYPE1__SUCCESSFUL, oldSuccessful, SUCCESSFUL_EDEFAULT, oldSuccessfulESet));
	}
	...
	public void setUpperLimit(double newUpperLimit) {
		...
		upperLimitESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JmtmodelPackage.MEASURE_TYPE1__UPPER_LIMIT, oldUpperLimit, upperLimit, !oldUpperLimitESet));
	}
	...
	public void unsetUpperLimit() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JmtmodelPackage.MEASURE_TYPE1__UPPER_LIMIT, oldUpperLimit, UPPER_LIMIT_EDEFAULT, oldUpperLimitESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JmtmodelPackage.MEASURE_TYPE1__ALFA:
				return getAlfa();
			case JmtmodelPackage.MEASURE_TYPE1__ANALYZED_SAMPLES:
				return getAnalyzedSamples();
			case JmtmodelPackage.MEASURE_TYPE1__DISCARDED_SAMPLES:
				return getDiscardedSamples();
			case JmtmodelPackage.MEASURE_TYPE1__LOWER_LIMIT:
				return getLowerLimit();
			case JmtmodelPackage.MEASURE_TYPE1__MAX_SAMPLES:
				return getMaxSamples();
			case JmtmodelPackage.MEASURE_TYPE1__MEAN_VALUE:
				return getMeanValue();
			case JmtmodelPackage.MEASURE_TYPE1__MEASURE_TYPE:
				return getMeasureType();
			case JmtmodelPackage.MEASURE_TYPE1__NODE_TYPE:
				return getNodeType();
			case JmtmodelPackage.MEASURE_TYPE1__PRECISION:
				return getPrecision();
			case JmtmodelPackage.MEASURE_TYPE1__SUCCESSFUL:
				return isSuccessful();
			case JmtmodelPackage.MEASURE_TYPE1__UPPER_LIMIT:
